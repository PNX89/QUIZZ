...
IMPLEMENTATIONS: dict[str, str] = {
    "NUMBER": "test_the_readme_states_numbers_that_are_true_today",
    "COMMAND": "test_every_command_the_readme_shows_is_one_this_repository_runs",
    "OUTPUT": "test_the_readme_transcript_is_the_demos_actual_output",
...
def _resolves(claim: str) -> bool:
    ...
    `quizz/thing.py` because that is the import path a reader types, and the file is at
    `src/quizz/thing.py`. Both are correct and a check that refused the first would be wrong.
    """
