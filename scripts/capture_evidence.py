...
WHY THIS EXISTS. The card at pnx89.github.io/QUIZZ shows the output of a real run and four
...
DEMO = ["uv", "run", "python", "examples/asof_session.py"]
...
def main() -> int:
    ...
    repo_slug = os.environ.get("GITHUB_REPOSITORY", "PNX89/QUIZZ")
    facts = {
        "tests": test_total(),
        "python": python_range(),
        "release": release(),
